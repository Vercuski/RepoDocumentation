# <a id="ONIONARCH_Presentation_API_Controllers_SampleController"></a> Class SampleController

Namespace: [ONIONARCH.Presentation.API.Controllers](ONIONARCH.Presentation.API.Controllers.md)  
Assembly: ONIONARCH.Presentation.API.dll  

Sample CRUD endpoints exposing the same operations over both persistence paths:
<code>api/Sample/EFCore/...</code> and <code>api/Sample/Dapper/...</code>.
...
[SampleController](ONIONARCH.Presentation.API.Controllers.SampleController.md)
...
The controller depends only on [ISender](ONIONARCH.Application.Abstractions.ISender.md) and Application contract types; it never
references Persistence (enforced by the Presentation architecture tests).

## Constructors

### <a id="ONIONARCH_Presentation_API_Controllers_SampleController__ctor_ONIONARCH_Application_Abstractions_ISender_"></a> SampleController\(ISender\)
...
Dispatches requests to their Application-layer handlers.
...
```csharp
[HttpPost("Dapper")]
public Task<IActionResult> CreateDapper(CreateSampleRequestDto dto)
```
...
200 with the number of rows affected.

#### Remarks

<code>POST api/Sample/Dapper</code>

### <a id="ONIONARCH_Presentation_API_Controllers_SampleController_CreateEFCore_ONIONARCH_Application_Contracts_Dtos_CreateSampleRequestDto_"></a> CreateEFCore\(CreateSampleRequestDto\)

Creates a sample entity via EF Core.

```csharp
[HttpPost("EFCore")]
public Task<IActionResult> CreateEFCore(CreateSampleRequestDto dto)
```
...
200 with the number of state entries written.

#### Remarks

<code>POST api/Sample/EFCore</code>

### <a id="ONIONARCH_Presentation_API_Controllers_SampleController_DeleteDapper_System_Int32_"></a> DeleteDapper\(int\)

Deletes a sample entity via Dapper.

```csharp
[HttpDelete("Dapper")]
public Task<IActionResult> DeleteDapper(int sampleId)
```
...
The key of the entity to delete (bound from the query string).

#### Returns

 [Task](https://learn.microsoft.com/dotnet/api/system.threading.tasks.task\-1)<[IActionResult](https://learn.microsoft.com/dotnet/api/microsoft.aspnetcore.mvc.iactionresult)\>

200 with the number of rows affected (0 if no row matched).

#### Remarks

<code>DELETE api/Sample/Dapper?sampleId={sampleId}</code>

### <a id="ONIONARCH_Presentation_API_Controllers_SampleController_DeleteEFCore_System_Int32_"></a> DeleteEFCore\(int\)
...
```csharp
[HttpDelete("EFCore")]
public Task<IActionResult> DeleteEFCore(int sampleId)
```
...
200 with the number of state entries written, or the mapped error response if the lookup failed.

#### Remarks

<code>DELETE api/Sample/EFCore?sampleId={sampleId}</code>

### <a id="ONIONARCH_Presentation_API_Controllers_SampleController_GetDapper_System_Int32_"></a> GetDapper\(int\)

Gets a sample entity by key via Dapper.

```csharp
[HttpGet("Dapper/{sampleId}")]
public Task<IActionResult> GetDapper(int sampleId)
```
...
200 with a [SampleDtoRecord](ONIONARCH.Application.Contracts.Dtos.SampleDtoRecord.md), or 404 if not found.

#### Remarks

<code>GET api/Sample/Dapper/{sampleId}</code>

### <a id="ONIONARCH_Presentation_API_Controllers_SampleController_GetEFCore_System_Int32_"></a> GetEFCore\(int\)

Gets a sample entity by key via EF Core.

```csharp
[HttpGet("EFCore/{sampleId}")]
public Task<IActionResult> GetEFCore(int sampleId)
```
...
<code>GET api/Sample/EFCore/{sampleId}</code>

### <a id="ONIONARCH_Presentation_API_Controllers_SampleController_UpdateDapper_ONIONARCH_Application_Contracts_Dtos_UpdateSampleRequestDto_"></a> UpdateDapper\(UpdateSampleRequestDto\)

Updates a sample entity via Dapper.

```csharp
[HttpPut("Dapper")]
public Task<IActionResult> UpdateDapper(UpdateSampleRequestDto dto)
```

#### Parameters

`dto` UpdateSampleRequestDto

The key of the entity to update and its new values.
...
<code>PUT api/Sample/Dapper</code>

### <a id="ONIONARCH_Presentation_API_Controllers_SampleController_UpdateEFCore_ONIONARCH_Application_Contracts_Dtos_UpdateSampleRequestDto_"></a> UpdateEFCore\(UpdateSampleRequestDto\)

Updates a sample entity via EF Core.

```csharp
[HttpPut("EFCore")]
public Task<IActionResult> UpdateEFCore(UpdateSampleRequestDto dto)
```
...
<code>PUT api/Sample/EFCore</code>
