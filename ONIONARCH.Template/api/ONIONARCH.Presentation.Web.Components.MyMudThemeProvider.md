# <a id="ONIONARCH_Presentation_Web_Components_MyMudThemeProvider"></a> Class MyMudThemeProvider

Namespace: [ONIONARCH.Presentation.Web.Components](ONIONARCH.Presentation.Web.Components.md)  
Assembly: ONIONARCH.Presentation.Web.dll  

```csharp
public class MyMudThemeProvider : ComponentBase, IComponent, IHandleEvent, IHandleAfterRender
```
...
[MyMudThemeProvider](ONIONARCH.Presentation.Web.Components.MyMudThemeProvider.md)
...
### <a id="ONIONARCH_Presentation_Web_Components_MyMudThemeProvider_MyTheme"></a> MyTheme

Gets the application's MudBlazor theme (light and dark palettes share the same primary and
app bar colors). A new instance is created on each access.

```csharp
public static MudTheme MyTheme { get; }
```
...
### <a id="ONIONARCH_Presentation_Web_Components_MyMudThemeProvider_BuildRenderTree_Microsoft_AspNetCore_Components_Rendering_RenderTreeBuilder_"></a> BuildRenderTree\(RenderTreeBuilder\)
