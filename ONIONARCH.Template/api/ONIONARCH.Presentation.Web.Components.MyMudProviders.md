# <a id="ONIONARCH_Presentation_Web_Components_MyMudProviders"></a> Class MyMudProviders
...
```csharp
public class MyMudProviders : ComponentBase, IComponent, IHandleEvent, IHandleAfterRender
```
...
[MyMudProviders](ONIONARCH.Presentation.Web.Components.MyMudProviders.md)
...
### <a id="ONIONARCH_Presentation_Web_Components_MyMudProviders_BuildRenderTree_Microsoft_AspNetCore_Components_Rendering_RenderTreeBuilder_"></a> BuildRenderTree\(RenderTreeBuilder\)
...
### <a id="ONIONARCH_Presentation_Web_Components_MyMudProviders_OnInitialized"></a> OnInitialized\(\)

Clears any pending snackbars and configures snackbar defaults: top-center position, at most
five visible, filled variant, duplicates suppressed.
